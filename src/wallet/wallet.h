...
public:
     ...
     */
    TransactionError FundTransaction(CMutableTransaction& tx, CAmount& nFeeRet, int& nChangePosInOut, bool lockUnspents, const std::set<int>& setSubtractFeeFromOutputs, CCoinControl);
     ...
     */
    TransactionError CreateTransaction(interfaces::Chain::Lock& locked_chain, const std::vector<CRecipient>& vecSend, CTransactionRef& tx, CReserveKey& reservekey, CAmount& nFeeRet, int& nChangePosInOut,
