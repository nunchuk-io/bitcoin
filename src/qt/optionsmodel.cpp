...
#include <wallet/wallet.h> // For DEFAULT_*
#include <net.h>
#include <netbase.h>
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DatabaseCache:
            ...
            return (int64_t)gArgs.GetArg("-dbcache", (qint64)nDefaultDbCache);
        case ThreadsScriptVerif:
            return (int64_t)gArgs.GetArg("-par", DEFAULT_SCRIPTCHECK_THREADS);
        case Listen:
    ...
    if(role == Qt::EditRole)
    {
        ...
        case Prune:
            if (value.toBool()) {
              ...
              settings.setValue("nPruneSize", nPruneSizeMiB / 1000);
        ...
        case PruneSize:
            ...
            break;
        case DatabaseCache:
            if (gArgs.GetArg("-dbcache", (qint64)nDefaultDbCache) != value) {
            ...
            break;
        case ThreadsScriptVerif:
            if (gArgs.GetArg("-par", DEFAULT_SCRIPTCHECK_THREADS) != value) {
